...
public class GLFont
{
     ...
     */
    public static GLFont fromTTF(FontboxManager manager, float px, ResourceLocation ttf) throws FontException
    {
     ...
     */
    public static GLFont fromSpriteFont(FontboxManager manager, String name, ResourceLocation image, ResourceLocation xml)
            throws FontException
    {
        ...
        try
        {
            ...
            GLFont f0 = fromBuffer(manager, name, buffer, buffer.getWidth(), buffer.getHeight(), metric);
     ...
     */
    public static GLFont fromFont(FontboxManager manager, Font font) throws FontException
    {
        if (manager == null || manager.tracer() == null)
            throw new IllegalArgumentException("trace may not be null");
        if (font == null)
        ...
        GLFont f0 = fromBuffer(manager, font.getFontName(), buffer, RASTER_DIM, RASTER_DIM, metric);
     ...
     *                       a GLFont container.
     */
    public static GLFont fromBuffer(FontboxManager manager, String name, BufferedImage image, int width, int height,
